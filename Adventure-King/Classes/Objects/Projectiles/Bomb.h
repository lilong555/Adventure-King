...
public:
    ...
    static constexpr float DEFAULT_THROW_SPEED_X = 300.0f;
    static constexpr float DEFAULT_THROW_SPEED_Y = 350.0f;
    static constexpr float EXPLOSION_RADIUS = 80.0f;      // 之前是 BOMB_EXPLOSION_RADIUS
    static constexpr float BASE_DAMAGE = 150.0f;          // 之前是 BOMB_DAMAGE
