...
SAVE["Mode::SAVE<br>In-game save menu"]
LOAD["Mode::LOAD<br>Main menu load game"]
START["Mode::START<br>Main menu start game"]
SaveButtons["Save button per slot"]
CloudUpload["云存 button<br>(save + upload all)"]
Delete["Delete button"]
LoadButtons["Load button per slot"]
CloudDownload["云读 button<br>(sync + load slot)"]
StartButtons["继续 (continue) if has save<br>新开 (new) if empty"]
CloudStart["云读 (sync first)"]
