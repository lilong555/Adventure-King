...
| 方法 | 职责 |
| --- | --- |
| `MonsterBase::attack()` | 攻击入口；把普攻委托给技能系统 |
| `SkillComponent::useActiveSkill(0)` | 执行技能校验（冷却/蓝耗等）并触发技能回调 |
| 技能回调 | 在合适时机生成命中框（命中检测） |

**示例**：`GoblinMonster::attack()` 会覆写该流程，手动编排攻击动画与命中框生成时机（命中帧由 `GameConfig::Monster::Goblin::ATTACK_HIT_FRAME_INDEX` 控制）。
...
来源： [Classes/Character/Monster/MonsterBase.cpp L16-L49](https://github.com/lilong555/Adventure-King/blob/60df0f40/Classes/Character/Monster/MonsterBase.cpp#L16-L49)
 ...
 [Adventure-King/Classes/Character/Monster/Monsters/GoblinMonster.cpp L116-L125](https://github.com/lilong555/Adventure-King/blob/60df0f40/Adventure-King/Classes/Character/Monster/Monsters/GoblinMonster.cpp#L116-L125)

 [Adventure-King/Classes/Configs/GameConfig.h L456-L457](https://github.com/lilong555/Adventure-King/blob/60df0f40/Adventure-King/Classes/Configs/GameConfig.h#L456-L457)
