...
TglPause -.-> PM_Show
TglPause -.-> PM_Hide
TglPause -.->…15346 chars truncated…``xml
// Example: Pause menu callback setup (lines 80-204)
auto pauseMenu = _gameUI->getPauseMenu();
if (pauseMenu)
{
    pauseMenu->setResumeCallback(<FileRef file-url="https://github.com/lilong555/Adventure-King/blob/60df0f40/this" undefined  file-path="this">Hii</FileRef> { /* ... */ });
    pauseMenu->setMainMenuCallback([]() { /* ... */ });
    pauseMenu->setSaveCallback(<FileRef file-url="https://github.com/lilong555/Adventure-King/blob/60df0f40/this" undefined  file-path="this">Hii</FileRef> { /* ... */ });
    pauseMenu->setLoadCallback(<FileRef file-url="https://github.com/lilong555/Adventure-King/blob/60df0f40/this" undefined  file-path="this">Hii</FileRef> { /* ... */ });
    pauseMenu->setInventoryCallback(<FileRef file-url="https://github.com/lilong555/Adventure-King/blob/60df0f40/this" undefined  file-path="this">Hii</FileRef> { /* ... */ });
}
```
