...
来源： [Adventure-King/Classes/Scenes/GameScene.h L38-L275](https://github.com/lilong555/Ad…2230 chars truncated…ysics World** - [GameScene.cpp L131-L148](https://github.com/lilong555/Adventure-King/blob/60df0f40/GameScene.cpp#L131-L148)
...
```xml
// InventoryComponent 设置回调
player->setEquipmentChangeCallback(<FileRef file-url="https://github.com/lilong555/Adventure-King/blob/60df0f40/this" undefined  file-path="this">Hii</FileRef> {
    // 触发 UI 刷新
    // 重新计算属性
    // 请求自动存档
});
