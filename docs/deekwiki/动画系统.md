    ...
    const std::function<void()>& onFinished)
{
    ...
    auto callbackAction = CallFunc::create(<FileRef file-url="https://github.com/lilong555/Adventure-King/blob/60df0f40/onFinished" undefined  file-path="onFinished">Hii</FileRef> {
        if (onFinished) onFinished();
    });
...
void attack()
{
    ...
    auto logicAction = Sequence::create(
        DelayTime::create(hitTime),
        CallFunc::create(<FileRef file-url="https://github.com/lilong555/Adventure-King/blob/60df0f40/this" undefined  file-path="this">Hii</FileRef> { spawnHitbox(); }),
        nullptr);
    ...
    auto full = Sequence::create(
        parallel,
        CallFunc::create(<FileRef file-url="https://github.com/lilong555/Adventure-King/blob/60df0f40/this" undefined  file-path="this">Hii</FileRef> { restoreIdleState(); }),
        nullptr);
