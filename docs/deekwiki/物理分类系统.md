# 物理分类系统（Physics Category System）
...
if (itemVsPlayer && player) {
    ...
    if (dropItem) {
        dropItem->scheduleOnce(<FileRef file-url="https://github.com/lilong555/Adventure-King/blob/60df0f40/dropItem, player" undefined  file-path="dropItem, player">Hii</FileRef> {
